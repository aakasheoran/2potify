...
const Sidebar = () => {
  ...
  console.log('You chose this playlist => ', playlistId);
  return (
    <div className='text-gray-400 p-5 text-sm border-r border-gray-500 overflow-y-scroll h-screen scrollbar-hide w-64'>
